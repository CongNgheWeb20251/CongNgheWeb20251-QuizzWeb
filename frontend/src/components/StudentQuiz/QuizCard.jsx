    ...
    >
      ...
      <div className="p-6 pb-4 flex-grow flex flex-col">
        <div className="flex items-start justify-between mb-4">
          <div className={`rounded-xl p-3 ${subjectColors[quiz.categoryIcon] || 'bg-blue-100 text-blue-700'} transition-transform ${isHovered ? 'scale-110' : 'scale-100'}`}>
            {subjectIcons[quiz.categoryIcon] || <BookOpen className="w-6 h-6" />}
          </div>
        ...
        <div className="mb-3">
          <h3 className="text-lg text-gray-900 mb-1 line-clamp-2 min-h-[3.5rem]">
            {quiz.title}
          </h3>
      ...
      <div className="px-6 py-4 border-t border-gray-100 bg-gray-100 mt-auto">
        <div className="flex gap-2">
          {quiz.status === 'completed' ? (
            <>
              <button
                className="flex-1 px-4 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all flex items-center justify-center gap-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
